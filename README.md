...
/c
│
├── 01_Basicos/          # Variables, ciclos, condicionales
├── 02_Punteros_Memoria/ # Aritmética de punteros, malloc/free
├── 03_Estructuras_Datos/# Listas enlazadas, pilas, colas, árboles
├── 04_Algoritmos/       # Ordenamiento, búsqueda
├── 05_Proyectos/        # Pequeñas herramientas o juegos (CLI)
├── lib/                 # Librerías propias reutilizables
...
1. **Clonar el repositorio:**
   ```bash
   git clone https://github.com/Radic4l3d/C.git
   cd C
   ```

2. **Navegar a cualquier directorio:**
   ```bash
   cd 01_Basicos
   ```
...
- **Depurador:** GDB o LLDB
- **Análisis de memoria:** Valgrind
- **Editor:** VSCode, Vim, Emacs, o tu preferido
...
Este es un repositorio de aprendizaje personal, pero sugerencias y mejoras son bienvenidas.

## 📄 Licencia

Contenido educativo de uso libre.
